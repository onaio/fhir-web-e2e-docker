...
window._env_ = {
  ...
  REACT_APP_OPENSRP_CLIENT_ID: 'fhir-staging-client',
  ...
  REACT_APP_DOMAIN_NAME: 'http://localhost:3001',
  REACT_APP_EXPRESS_OAUTH_GET_STATE_URL: 'http://localhost:3001/oauth/state',
  REACT_APP_EXPRESS_OAUTH_LOGOUT_URL: 'http://localhost:3001/logout',
